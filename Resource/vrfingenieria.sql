...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-05-2024 a las 03:44:48
...
CREATE TABLE `clientes` (
  ...
  `telefonoEmpresa` bigint NOT NULL,
...
(18001, 0, 0, 0, 'na', 'na', 'na', 'na', 'na', '00:00:00', '00:00:00', 0, 'na', 'na'),
(18002, 27, 6, 18, 'Banco de Bogota', '5to piso', 'Mesa de Dinero', 'Mantenimiento Preventivo', 'AA(indoorC4V_VRF)', '12:00:00', '14:00:00', 4, 'Jhonys de Moya', 'Alfonso Escobar'),
(18003, 27, 6, 18, 'Banco de Bogota', 'CAD', 'sotano 3', 'Mantenimiento Preventivo', 'AA(indoorC4V_VRF), AA(indoorC1V_VRF) ', '14:00:00', '17:30:00', 4, 'Eric Martinez', 'n/a'),
(18004, 28, 6, 18, 'Banco de Bogota', 'Local Premium', 'oficinas', 'Mantenimiento Preventivo', 'AA(indoorVRF)', '11:00:00', '14:00:00', 4, 'Eric Martinez', 'n/a'),
(18005, 27, 6, 18, 'Banco de Bogota', 'Edificio Regional', 'Pisos 3, 4, 5', 'Mantenimiento Preventivo', 'CVA', '14:00:00', '17:30:00', 4, 'Jhonys de Moya', 'Alfonso Escobar'),
(18006, 28, 6, 18, 'Banco de Bogota', 'Sucursal Bancaria', 'Interior', 'Mantenimiento Preventivo', 'AA(indoorVRF)', '09:00:00', '14:00:00', 4, 'Jhonys de Moya', 'Alfonso Escobar'),
(18007, 28, 6, 18, 'Banco de Bogota', 'Centro Nelmar', 'Predeterminada', 'Mantenimiento Preventivo', 'AA', '14:30:00', '17:30:00', 4, 'Eric Martinez, Jhonys de Moya', 'Alfonso Escobar'),
(18008, 29, 6, 18, 'Banco de Bogota', 'Sucursal Bancaria', 'Interior', 'Mantenimiento Preventivo', 'AA, VCE', '08:00:00', '17:30:00', 4, 'Jhonys de Moya', 'Alfonso Escobar'),
(18009, 30, 6, 18, 'Edificio Banco de Bogota', 'Terraza', 'Terraza', 'Mantenimiento Correctivo', 'TCE', '07:30:00', '01:00:00', 4, 'Eric Martinez, Jhonys de Moya', 'Alfonso Escobar'),
(18010, 30, 6, 18, 'Edificio Banco de Bogota', 'Terraza', 'Terraza', 'Mantenimiento Preventivo', 'BAC, BAF', '09:00:00', '12:00:00', 4, 'Eric Martinez', 'n/a'),
(18011, 3, 6, 18, 'Edificio Banco de Bogota', 'UPS principal sotano 1', 'Predeterminada', 'Mantenimiento Preventivo', 'AA', '08:00:00', '10:00:00', 1, 'Eric Martinez, Jhonys de Moya', 'Alfonso Escobar');
...
CREATE TABLE `empleados` (
  ...
  `noIdentificacionEmpleado` int NOT NULL,
  `pswAsignadoEmpleado` varchar(100) NOT NULL
...
INSERT INTO `empleados` (`idEmpleado`, `noIdentificacionEmpleado`, `pswAsignadoEmpleado`) VALUES
(1, 1140851982, 'qwerty');
...
CREATE TABLE `historialvisitas` (
  ...
  `noIdentificacionVisitanteHistoral` varchar(100) NOT NULL,
  `nombreVisitanteHistorial` varchar(100) NOT NULL,
  `fechaHoraHistorial` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `historialvisitas` (`idHistorial`, `noIdentificacionVisitanteHistoral`, `nombreVisitanteHistorial`, `fechaHoraHistorial`) VALUES
(1, '1140851982', 'eric', 'PorDefinir'),
(7, '1140851982', 'Eric', 'porDefinir'),
(8, '1140851982', 'Eric', 'porDefinir'),
(9, '1140851982', 'Eric', 'porDefinir'),
(10, '1140851982', 'Eric', 'porDefinir'),
(11, '1140851982', 'Eric', 'porDefinir'),
(12, '1140851982', 'Eric', 'porDefinir'),
(13, '1140851982', 'Eric', 'porDefinir'),
(14, '', 'Eric', 'porDefinir'),
(15, '', 'Eric', 'porDefinir'),
(16, '', 'Eric', 'porDefinir'),
(17, '1140851982', 'Eric', 'porDefinir');
...
CREATE TABLE `listado_herramientas` (
  ...
  `cantidadHerramienta` int NOT NULL,
  `costoCOP` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `parametros_mtto_aasingle` (
  ...
  `a2` float NOT NULL,
  `a3` float NOT NULL,
  `pSuccionPSI` int NOT NULL,
  `pDescargaPSI` int NOT NULL,
...
CREATE TABLE `usuarioactivo` (
  `idUsuActivo` int NOT NULL,
  `nombreUsuActivo` text NOT NULL,
  `identUsuActivo` int NOT NULL,
...
--
ALTER TABLE `clientes`
  MODIFY `idCliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1009;

--
-- AUTO_INCREMENT de la tabla `cronograma`
--
ALTER TABLE `cronograma`
  MODIFY `idCronograma` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18012;
...
--
ALTER TABLE `historialvisitas`
  MODIFY `idHistorial` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `lista_tipo_equipos`
  MODIFY `idTipoEquipo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `parametros_mtto_torres`
  MODIFY `idhistorial` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7906;

--
-- AUTO_INCREMENT de la tabla `usuarioactivo`
--
ALTER TABLE `usuarioactivo`
  MODIFY `idUsuActivo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
COMMIT;
