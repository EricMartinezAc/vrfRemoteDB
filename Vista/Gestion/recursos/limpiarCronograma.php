<div class="container">
	...
	<div class="modal fade" id="LimpiarTablaActividad" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formLimpiarActividad" method="GET" action="php/limpiarTablaActividad.php">
