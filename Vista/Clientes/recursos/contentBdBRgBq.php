...
<!-- CONTENIDO -->
<div class="container">
<div class="contenidoBdB">
	

<table class=" table-condensed btn-null  " id="tablaElement" style="width: 100%; height: 100%">
		<tr class="info tableGeneral" style="width: 100%;height: 50%">
					<th >
						<button style="backgro"></button>
					</th>
					<th >
