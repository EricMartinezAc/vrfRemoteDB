...
$query = mysql_query("")or die("elemento no agregado");


?>
INSERT INTO inventario (nombre, tipo, marca, referencia,serial, cantidad,estado,sede) VALUES ('$nombreEle','$tipoEle','$marcaEle','$refEle','$serialEle','$cantEle','$estadoEle','$sedeEle')